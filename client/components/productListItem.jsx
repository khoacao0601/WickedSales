...
export default function ProductListItem(props) {
  ...
  return (
    <div className="list d-inline-block card col-xl-2 col-lg-4 col-md-3 col-sm-3 col-9 ml-5 mt-5 shadow-lg p-3 mb-5 bg-white hoverZoom" onClick={() => props.setView('details', { productId: props.content.productId })}>
